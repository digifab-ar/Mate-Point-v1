/*
 * Mate Point firmware v0-3-2 — Waveshare + Nobana UART (timer MQTT + UI dispensado)
 * Base: mate_point_v0-3-1
 *
 * Pantalla dispensado: T_viva, countdown duration_ms, boton Parar (stop manual §7.4).
 *
