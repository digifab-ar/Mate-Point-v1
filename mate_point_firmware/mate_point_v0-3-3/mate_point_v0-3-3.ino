/*
 * Mate Point firmware v0-3-3 — Waveshare + Nobana UART
 * Base: mate_point_v0-3-2
 *
 * Parar: pre-stop 200 ms → 22+00. UI contrato (countdown) desacoplado del ciclo hidraulico.
 * terminado al countdown 0; T_viva viva; sin MQTT al Parar.
 *
