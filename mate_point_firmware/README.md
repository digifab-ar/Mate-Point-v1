...
| [`PLAN-MATE-POINT-v0-3.md`](PLAN-MATE-POINT-v0-3.md) | Producto Waveshare + Nobana — v0-3-1 (OK) · **v0-3-2** (UI dispensado) |
...
| **v0-3-1** | [`mate_point_v0-3-1/`](mate_point_v0-3-1/) | **E2E OK** banco (2026-06-05) — timer MQTT + Nobana |
| **v0-3-2** | [`mate_point_v0-3-2/`](mate_point_v0-3-2/) | **Implementado** — UI dispensado + Parar; banco pendiente |
...
```
mate_point_firmware/mate_point_v0-2/mate_point_v0-2.ino          ← producto legacy (Comprar + QR simulado)
mate_point_firmware/mate_point_v0-3-1/mate_point_v0-3-1.ino      ← producto banco OK (timer MQTT)
mate_point_firmware/mate_point_v0-3-2/mate_point_v0-3-2.ino    ← siguiente: UI dispensado + Parar (planificado)
