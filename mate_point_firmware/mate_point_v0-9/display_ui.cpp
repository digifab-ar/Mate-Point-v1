...
void display_ui_init()
{
    ...
    lv_label_set_long_mode(label_termo_debug_1, LV_LABEL_LONG_WRAP);
    lv_label_set_long_mode(label_termo_debug_2, LV_LABEL_LONG_WRAP);
    lv_obj_set_width(label_termo_debug_1, UI_PANEL_W - 32);
    lv_obj_set_width(label_termo_debug_2, UI_PANEL_W - 32);
    lv_obj_set_style_text_font(label_termo_debug_1, UI_FONT_LABEL, 0);
    lv_obj_set_style_text_font(label_termo_debug_2, UI_FONT_LABEL, 0);
    lv_obj_set_style_text_color(label_termo_debug_1, UI_COLOR_ORANGE_LIGHT, 0);
    lv_obj_set_style_text_color(label_termo_debug_2, UI_COLOR_ORANGE_LIGHT, 0);
    lv_obj_align(label_termo_debug_1, LV_ALIGN_TOP_RIGHT, -16, 16);
    lv_obj_align(label_termo_debug_2, LV_ALIGN_TOP_RIGHT, -16, 40);
