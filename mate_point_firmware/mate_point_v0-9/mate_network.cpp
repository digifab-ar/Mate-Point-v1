...
static uint32_t pending_pause_timeout_ms = 0;
...
static void on_mqtt_message(char *topic, byte *payload, unsigned int length)
{
    ...
    const uint32_t duration_ms = doc["duration_ms"] | 120000U;
    const uint32_t pause_timeout_ms = doc["pause_timeout_ms"] | 0U;
    ...
    pending_pause_timeout_ms = pause_timeout_ms;
