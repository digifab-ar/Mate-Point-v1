/*
 * Mate Point firmware v0-3-1 — Waveshare + Nobana UART (timer MQTT)
 * Base: mate_point_v0-3
 *
 * duration_ms MQTT = tiempo total dispensado (activo + pre-stop + stop).
 * UI terminado al fin del stop; cooldown en background.
 *
