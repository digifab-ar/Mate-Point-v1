...
/** Stop manual — pre-stop 200 ms luego 22+00 directo (sin 22+04); cooldown sesión 15 s. */
bool nobana_dispense_abort();

/** Pausa (Parar) — mismo corte corto; cooldown corto (`PAUSE_COOLDOWN_MS`) para reanudar. */
