/*
 * Mate Point firmware v0-8 — flota N máquinas (device_id ↔ caja MP).
 * Base v0-9: oferta servidor, litros ms/120000, piso 80 °C UI,
 * retiro termo = pausa (WAIT_TERMO_RESUME), VL6180.
 *
 * USB CDC On Boot = Disabled.
 * UART0 (Serial) @ 9600 GPIO44/43 — solo protocolo Nobana, sin logs.
 *
 * Por unidad, antes de flash: DEVICE_ID en config.h + qr_static_img.c de ESA caja.
 */
